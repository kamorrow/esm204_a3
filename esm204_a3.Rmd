...
benefit_p_sq <- (dmd_sq_low * 3) + (dmd_sq_high * 3)
#I think this needs to be altered too once the supply curve is calculated. It should be the triangle above the supply curve and below the market price.
